...
export default {
	...
	methods: {
		...
		// 			'https://52.59.240.119/api/users/updateuser',
		// 			formData,
		// 			{
		// 				headers: {
		...
		async checkIfGoogleOrFacebookUser() {
			try {
				...
				if (socialCheck == "true") {
					...
					const response = await axios.post('https://52.59.240.119/api/users', mydata);
		...
		handleFileChange() {
			...
			axios.post('https://52.59.240.119/api/comments/users', formData)
				.then(response => {
					// Handle success
		...
		// 		const response = await axios.put(`https://52.59.240.119/api/users/${this.formData.sub}`, FormDataa);
		...
		// 		const response = await fetch(`https://52.59.240.119/api/users/${this.formData.sub}`, requestOptions);
		...
		// 		const response = await axios.put(`https://52.59.240.119/api/users/${this.formData.sub}`, formdata, {
		// 			headers: {
		// 				'Content-Type': 'multipart/form-data'
		// 			}
		// 		});
