<template>
  ...
  <div id="particlees">
    ...
    <vue-particles color="#dedede" particleOpacity="1" :particlesNumber="pNum" shapeType="circle" particleSize="4"
      ...
      v-if="$route.path !== '/termofservice' && $route.path !== '/privacypolicy' && $route.path !== '/cookies' && $route.path !== '/map' && $route.path !== '/map2' && $route.path !== '/map3' && $route.path !== '/newstories' && $route.path !== '/carslistingdetails'" />
  ...
  <div
    v-if="$route.path !== '/termofservice' && $route.path !== '/privacypolicy' && $route.path !== '/carslistingdetails' && $route.path !== '/buy4' && $route.path !== '/buy'">
