<template>
    <section class="termsOfService-section my-5">
        <div class="container">
            <div class="termsOfService-content">
                <div class="termsOfService-details1 mb-5">
                    <h1 class="banner-title termsOfService-title">TERMS AND CONDITIONS</h1>
                    <p class="banner-para termsOfService-para">Last updated November 30, 2023</p>
                </div>
                <div class="termsOfService-details2">
                    <h2 class="launching-h2-title termsOfService-h2-title">AGREEMENT TO OUR LEGAL TERMS</h2>
                    <br>

                    <p class="map-para line-height-termsOfService">We are RevvdOut ("Company," "we," "us," "our"), a
                        company registered in Luxembourg at __________, __________.</p>

                    <p class="map-para line-height-termsOfService">We operate the website <a class="termsService"
                            href="http://www.revvdout.com">http://www.revvdout.com</a> (the "Site"), the mobile
                        application RevvdOut (the "App"), as well as any other related products and services that refer
                        or link to these legal terms (the "Legal Terms") (collectively, the "Services").</p>

                    <p class="map-para line-height-termsOfService">We provide a marketplace for modified and super cars,
                        a community forum page to discuss cars related topics and a tuning shop directory service.</p>

                    <p class="map-para line-height-termsOfService">You can contact us by email at __________ or by mail
                        to __________, __________, Luxembourg.</p>

                    <!-- <h2 class="map-para">Legal Terms</h2> -->

                    <p class="map-para line-height-termsOfService">These Legal Terms constitute a legally binding
                        agreement made between you, whether personally or on behalf of an entity ("you"), and RevvdOut,
                    ...
                    <p class="map-para line-height-termsOfService">Supplemental terms and conditions or documents that
                        ...
                        these Legal Terms from time to time. We will alert you about any changes by updating the "Last
                        updated" date of these Legal Terms, and you waive any right to receive specific notice of each
                        such change. It is your responsibility to periodically review these Legal Terms to stay informed
                        ...
                        date such revised Legal Terms are posted.</p>

                    <p class="map-para line-height-termsOfService">The Services are intended for users who are at least
                        18 years old. Persons under the age of 18 are not permitted to use or register for the Services.
                    </p>

                    <p class="map-para line-height-termsOfService">We recommend that you print a copy of these Legal
                        Terms for your records.</p>
                </div>
                <div class="termsOfService-details2">
                    <h2 class="launching-h2-title termsOfService-h2-title mb-3">Table of Contents</h2>

                    <ol class="termsService">
                        <li><a class="termsService" href="#services">OUR SERVICES</a></li>
                        <li><a class="termsService" href="#intellectual-property">INTELLECTUAL PROPERTY RIGHTS</a></li>
                        <li><a class="termsService" href="#user-representations">USER REPRESENTATIONS</a></li>
                        <li><a class="termsService" href="#user-registration">USER REGISTRATION</a></li>
                        <li><a class="termsService" href="#software">SOFTWARE</a></li>
                        <li><a class="termsService" href="#prohibited-activities">PROHIBITED ACTIVITIES</a></li>
                        <li><a class="termsService" href="#user-generated-contributions">USER GENERATED
                                CONTRIBUTIONS</a></li>
                        <li><a class="termsService" href="#contribution-license">CONTRIBUTION LICENSE</a></li>
                        <li><a class="termsService" href="#guidelines-for-reviews">GUIDELINES FOR REVIEWS</a></li>
                        <li><a class="termsService" href="#mobile-application-license">MOBILE APPLICATION LICENSE</a>
                        </li>
                        <li><a class="termsService" href="#social-media">SOCIAL MEDIA</a></li>
                        <li><a class="termsService" href="#third-party-websites">THIRD-PARTY WEBSITES AND CONTENT</a>
                        </li>
                        <li><a class="termsService" href="#advertisers">ADVERTISERS</a></li>
                        <li><a class="termsService" href="#services-management">SERVICES MANAGEMENT</a></li>
                        <li><a class="termsService" href="#privacy-policy">PRIVACY POLICY</a></li>
                        <li><a class="termsService" href="#term-and-termination">TERM AND TERMINATION</a></li>
                        <li><a class="termsService" href="#modifications-and-interruptions">MODIFICATIONS AND
                                INTERRUPTIONS</a></li>
                        <li><a class="termsService" href="#governing-law">GOVERNING LAW</a></li>
                        <li><a class="termsService" href="#dispute-resolution">DISPUTE RESOLUTION</a></li>
                        <li><a class="termsService" href="#corrections">CORRECTIONS</a></li>
                        <li><a class="termsService" href="#disclaimer">DISCLAIMER</a></li>
                        <li><a class="termsService" href="#limitations-of-liability">LIMITATIONS OF LIABILITY</a></li>
                        <li><a class="termsService" href="#indemnification">INDEMNIFICATION</a></li>
                        <li><a class="termsService" href="#user-data">USER DATA</a></li>
                        <li><a class="termsService" href="#electronic-communications">ELECTRONIC COMMUNICATIONS,
                                TRANSACTIONS, AND SIGNATURES</a></li>
                        <li><a class="termsService" href="#california-users">CALIFORNIA USERS AND RESIDENTS</a></li>
                        <li><a class="termsService" href="#miscellaneous">MISCELLANEOUS</a></li>
                        <li><a class="termsService" href="#contact-us">CONTACT US</a></li>
                    </ol>
                </div>

                <div class="termsOfService-details2 my-5" id="services">
                    <h2 class="launching-h2-title termsOfService-h2-title">1. OUR SERVICES</h2>
                    <br>

                    <p class="map-para line-height-termsOfService">The information provided when using the Services is
                        not intended for distribution to or use by any person or entity in any jurisdiction or country
                    ...
                    <p class="map-para line-height-termsOfService">The Services are not tailored to comply with
                        ...
                        subjected to such laws, you may not use the Services. You may not use the Services in a way that
                        would violate the Gramm-Leach-Bliley Act (GLBA).</p>

                </div>

                <div class="termsOfService-details2 my-5" id="intellectual-property">
                    <h2 class="launching-h2-title termsOfService-h2-title">2. INTELLECTUAL PROPERTY RIGHTS</h2>
                    <br>
                    <p class="banner-para termsOfService-para">Our intellectual property</p>

                    <p class="map-para line-height-termsOfService">We are the owner or the licensee of all intellectual
                    ...
                    <p class="map-para line-height-termsOfService">Our Content and Marks are protected by copyright and
                        trademark laws (and various other intellectual property rights and unfair competition laws) and
                        treaties in the United States and around the world.</p>
                    <p class="map-para line-height-termsOfService">The Content and Marks are provided in or through the
                        Services "AS IS" for your personal, non-commercial use or internal business purpose only.</p>

                   
                    <p class="banner-para termsOfService-para">Your use of our Services</p>

                    <p class="map-para line-height-termsOfService">Your use of our Services</p>

                    <p class="map-para line-height-termsOfService">Subject to your compliance with these Legal Terms,
                        including the <a class="termsService" href="#prohibited-activities"> "PROHIBITED ACTIVITIES"
                        </a> section below, we grant you a non-exclusive, non-transferable, revocable license to:</p>
                    ...
                    <p class="map-para line-height-termsOfService">Except as set out in this section or elsewhere in our
                    ...
                    <p class="map-para line-height-termsOfService">If you wish to make any use of the Services, Content,
                        or Marks other than as set out in this section or elsewhere in our Legal Terms, please address
                        your request to: __________. If we ever grant you the permission to post, reproduce, or publicly
                    ...
                    <p class="map-para line-height-termsOfService">We reserve all rights not expressly granted to you in
                        and to the Services, Content, and Marks.</p>

                    <p class="map-para line-height-termsOfService">Any breach of these Intellectual Property Rights will
                        constitute a material breach of our Legal Terms and your right to use our Services will
                        terminate immediately.</p>

                    <p class="banner-para termsOfService-para">Your submissions and contributions</p>

                    <p class="map-para line-height-termsOfService">Please review this section and the <a
                            class="termsService" href="#prohibited-activities"> "PROHIBITED ACTIVITIES" </a> section
                        carefully prior to using our Services to understand the (a) rights you give us and (b)
                        obligations you have when you post or upload any content through the Services.</p>

                    <p class="map-para line-height-termsOfService"> <strong> Submissions: </strong> By directly sending
                        us any question, comment, suggestion, idea, feedback, or other information about the Services
                    ...
                    <p class="map-para line-height-termsOfService"> <strong> Contributions: </strong> The Services may
                        invite you to chat, contribute to, or participate in blogs, message boards, online forums, and
                        other functionality during which you may create, submit, post, display, transmit, publish,
                        distribute, or broadcast content and materials to us or through the Services, including but not
                        limited to text, writings, video, audio, photographs, music, graphics, comments, reviews, rating
                        suggestions, personal information, or other material ("Contributions"). Any Submission that is
                        publicly posted shall also be treated as a Contribution.</p>

                    <p class="map-para line-height-termsOfService">You understand that Contributions may be viewable by
                        other users of the Services and possibly through third-party websites.</p>

                    <p class="map-para line-height-termsOfService"> <strong> When you post Contributions, you grant us a
                            license (including use of your name, trademarks, and logos): </strong> By posting any
                        Contributions, you grant us an unrestricted, unlimited, irrevocable, perpetual, non-exclusive,
                        ...
                        may occur in any media formats and through any media channels.</p>

                    <p class="map-para line-height-termsOfService">This license includes our use of your name, company
                        name, and franchise name, as applicable, and any of the trademarks, service marks, trade names,
                        logos, and personal and commercial images you provide.</p>

                    <p class="map-para line-height-termsOfService"> <strong> You are responsible for what you post or
                            upload: </strong> By sending us Submissions and/or posting Contributions through any part of
                        the Services or making Contributions accessible through the Services by linking your account
                        through the Services to any of your social networking accounts, you:</p>

                    <ul class="termsService">
                        <li>confirm that you have read and agree with our <a class="termsService"
                                href="#prohibited-activities"> "PROHIBITED ACTIVITIES" </a> and will not post, send,
                    ...
                    <p class="map-para line-height-termsOfService">You are solely responsible for your Submissions
                        and/or Contributions and you expressly agree to reimburse us for any and all losses that we may
                        suffer because of your breach of (a) this section, (b) any third party’s intellectual property
                        rights, or (c) applicable law.</p>

                    <p class="map-para line-height-termsOfService"> <strong> We may remove or edit your Content:
                        </strong> Although we have no obligation to monitor any Contributions, we shall have the right
                        to remove or edit any Contributions at any time without notice if in our reasonable opinion we
                        consider such Contributions harmful or in breach of these Legal Terms. If we remove or edit any
                        such Contributions, we may also suspend or disable your account and report you to the
                        authorities.</p>
                </div>

                <div class="termsOfService-details2 my-5" id="user-representations">
                    <h2 class="launching-h2-title termsOfService-h2-title">3. USER REPRESENTATIONS</h2>
                    <br>

                    <p class="map-para line-height-termsOfService">By using the Services, you represent and warrant
                        that: (1) all registration information you submit will be true, accurate, current, and complete;
                        ...
                        Legal Terms; (4) you are not a minor in the jurisdiction in which you reside; (5) you will not
                        ...
                        your use of the Services will not violate any applicable law or regulation.</p>

                    <p class="map-para line-height-termsOfService">If you provide any information that is untrue,
                        inaccurate, not current, or incomplete, we have the right to suspend or terminate your account
                        and refuse any and all current or future use of the Services (or any portion thereof).</p>
                </div>

                <div class="termsOfService-details2 my-5" id="user-registration">
                    <h2 class="launching-h2-title termsOfService-h2-title">4. USER REGISTRATION</h2>
                    <br>

                    <p class="map-para line-height-termsOfService">You may be required to register to use the Services.
                ...
                <div class="termsOfService-details2 my-5" id="software">
                    <h2 class="launching-h2-title termsOfService-h2-title">5. SOFTWARE</h2>
                    <br>

                    <p class="map-para line-height-termsOfService">We may include software for use in connection with
                        our Services. If such software is accompanied by an end user license agreement ("EULA"), the
                        terms of the EULA will govern your use of the software. If such software is not accompanied by a
                        EULA, then we grant to you a non-exclusive, revocable, personal, and non-transferable license to
                        use such software solely in connection with our services and in accordance with these Legal
                        Terms. Any software and any related documentation is provided "AS IS" without warranty of any
                        ...
                        any software except in accordance with the EULA or these Legal Terms.</p>

                </div>

                <div class="termsOfService-details2 my-5" id="prohibited-activities">
                    <h2 class="launching-h2-title termsOfService-h2-title">6. PROHIBITED ACTIVITIES</h2>
                    <br>

                    <p class="map-para line-height-termsOfService">You may not access or use the Services for any
                    ...
                    <p class="map-para line-height-termsOfService">As a user of the Services, you agree not to:</p>
                    ...
                    <ul class="termsService">
                        ...
                        <li>Interfere with, disrupt, or create an undue burden on the Services or the networks or
                            services connected to the Services.</li>
                        ...
                        <li>Except as permitted by applicable law, decipher, decompile, disassemble, or reverse engineer
                            any of the software comprising or in any way making up a part of the Services.</li>
                ...
                <div class="termsOfService-details2 my-5" id="user-generated-contributions">
                    <h2 class="launching-h2-title termsOfService-h2-title">7. USER GENERATED CONTRIBUTIONS</h2>
                    <br>

                    <p class="map-para line-height-termsOfService">The Services may invite you to chat, contribute to,
                        or participate in blogs, message boards, online forums, and other functionality, and may provide
                    ...
                    <ul class="termsService">
                        ...
                        <li>Your Contributions are not used to harass or threaten (in the legal sense of those terms)
                            any other person and to promote violence against a specific person or class of people.</li>
                        ...
                        <li>Your Contributions do not otherwise violate, or link to material that violates, any
                            provision of these Legal Terms, or any applicable law or regulation.</li>
                    </ul>
                    <p class="map-para line-height-termsOfService">Any use of the Services in violation of the foregoing
                        violates these Legal Terms and may result in, among other things, termination or suspension of
                        your rights to use the Services.</p>
                </div>

                <div class="termsOfService-details2 my-5" id="contribution-license">
                    <h2 class="launching-h2-title termsOfService-h2-title">8. CONTRIBUTION LICENSE</h2>
                    <br>

                    <p class="map-para line-height-termsOfService">By posting your Contributions to any part of the
                        Services or making Contributions accessible to the Services by linking your account from the
                        Services to any of your social networking accounts, you automatically grant, and you represent
                        ...
                        to host, use, copy, reproduce, disclose, sell, resell, publish, broadcast, retitle, archive,
                        store, cache, publicly perform, publicly display, reformat, translate, transmit, excerpt (in
                        whole or in part), and distribute such Contributions (including, without limitation, your image
                    ...
                    <p class="map-para line-height-termsOfService">This license will apply to any form, media, or
                        technology now known or hereafter developed, and includes our use of your name, company name,
                        and franchise name, as applicable, and any of the trademarks, service marks, trade names, logos,
                    ...
                    <p class="map-para line-height-termsOfService">We do not assert any ownership over your
                    ...
                    <p class="map-para line-height-termsOfService">We have the right, in our sole and absolute
                        ...
                        or delete any Contributions at any time and for any reason, without notice. We have no
                        obligation to monitor your Contributions.</p>

                </div>

                <div class="termsOfService-details2 my-5" id="guidelines-for-reviews">
                    <h2 class="launching-h2-title termsOfService-h2-title">9. GUIDELINES FOR REVIEWS</h2>
                    <br>

                    <p class="map-para line-height-termsOfService">We may provide you areas on the Services to leave
                        ...
                        not contain offensive profanity, or abusive, racist, offensive, or hateful language; (3) your
                        ...
                        (7) you may not post any false or misleading statements; and (8) you may not organize a campaign
                        encouraging others to post reviews, whether positive or negative.</p>

                    <p class="map-para line-height-termsOfService">We may accept, reject, or remove reviews in our sole
                        discretion. We have absolutely no obligation to screen reviews or to delete reviews, even if
                ...
                <div class="termsOfService-details2 my-5" id="mobile-application-license">
                    <h2 class="launching-h2-title termsOfService-h2-title">10. MOBILE APPLICATION LICENSE</h2>
                    <br>
                    <p class="banner-para termsOfService-para">Use License</p>

                    <p class="map-para line-height-termsOfService">If you access the Services via the App, then we grant
                        you a revocable, non-exclusive, non-transferable, limited right to install and use the App on
                        ...
                        designed or intended; (6) make the App available over a network or other environment permitting
                        access or use by multiple devices or users at the same time; (7) use the App for creating a
                        product, service, or software that is, directly or indirectly, competitive with or in any way a
                        substitute for the App; (8) use the App to send automated queries to any website or to send any
                    ...
                    <p class="banner-para termsOfService-para">Apple and Android Devices</p>

                    <p class="map-para line-height-termsOfService">The following terms apply when you use the App
                        obtained from either the Apple Store or Google Play (each an "App Distributor") to access the
                        Services: (1) the license granted to you for our App is limited to a non-transferable license to
                        ...
                        and support services with respect to the App; (3) in the event of any failure of the App to
                        ...
                        paid for the App, and to the maximum extent permitted by applicable law, the App Distributor
                        will have no other warranty obligation whatsoever with respect to the App; (4) you represent and
                        warrant that (i) you are not located in a country that is subject to a US government embargo, or
                        that has been designated by the US government as a "terrorist supporting" country and (ii) you
                        ...
                        contained in these Legal Terms against you as a third-party beneficiary thereof</p>
                </div>

                <div class="termsOfService-details2 my-5" id="social-media">
                    <h2 class="launching-h2-title termsOfService-h2-title">11. SOCIAL MEDIA</h2>
                    <br>

                    <p class="map-para line-height-termsOfService">As part of the functionality of the Services, you may
                        link your account with online accounts you have with third-party service providers (each such
                        account, a "Third-Party Account") by either: (1) providing your Third-Party Account login
                        information through the Services; or (2) allowing us to access your Third-Party Account, as is
                        permitted under the applicable terms and conditions that govern your use of each Third-Party
                        Account. You represent and warrant that you are entitled to disclose your Third-Party Account
                        login information to us and/or grant us access to your Third-Party Account, without breach by
                        ...
                        any Third-Party Accounts, you understand that (1) we may access, make available, and store (if
                        ...
                        SOLELY BY YOUR AGREEMENT(S) WITH SUCH THIRD-PARTY SERVICE PROVIDERS. We make no effort to review
                        any Social Network Content for any purpose, including but not limited to, for accuracy,
                ...
                <div class="termsOfService-details2 my-5" id="third-party-websites">
                    <h2 class="launching-h2-title termsOfService-h2-title">12. THIRD-PARTY WEBSITES AND CONTENT</h2>
                    <br>

                    <p class="map-para line-height-termsOfService">The Services may contain (or you may be sent via the
                        Site or App) links to other websites ("Third-Party Websites") as well as articles, photographs,
                        ...
                        the Third-Party Websites or the Third-Party Content. Inclusion of, linking to, or permitting the
                        ...
                        resulting in any way from any Third-Party Content or any contact with Third-Party Websites.</p>
                </div>

                <div class="termsOfService-details2 my-5" id="advertisers">
                    <h2 class="launching-h2-title termsOfService-h2-title">13. ADVERTISERS</h2>
                    <br>

                    <p class="map-para line-height-termsOfService">We allow advertisers to display their advertisements
                        and other information in certain areas of the Services, such as sidebar advertisements or banner
                ...
                <div class="termsOfService-details2 my-5" id="services-management">
                    <h2 class="launching-h2-title termsOfService-h2-title">14. SERVICES MANAGEMENT</h2>
                    <br>

                    <p class="map-para line-height-termsOfService">We reserve the right, but not the obligation, to: (1)
                        monitor the Services for violations of these Legal Terms; (2) take appropriate legal action
                        against anyone who, in our sole discretion, violates the law or these Legal Terms, including
                        ...
                        the Services or otherwise disable all files and content that are excessive in size or are in any
                        way burdensome to our systems; and (5) otherwise manage the Services in a manner designed to
                        protect our rights and property and to facilitate the proper functioning of the Services.</p>
                </div>

                <div class="termsOfService-details2 my-5" id="privacy-policy">
                    <h2 class="launching-h2-title termsOfService-h2-title">15. PRIVACY POLICY</h2>
                    <br>

                    <p class="map-para line-height-termsOfService">We care about data privacy and security. Please
                        review our Privacy Policy: <a class="termsService" target="_blank"
                            href="http://www.revvdout.com"> http://www.revvdout.com/privacy. </a> By using the Services,
                        you agree to be bound by our Privacy Policy, which is incorporated into these Legal Terms.
                        Please be advised the Services are hosted in Luxembourg. If you access the Services from any
                        other region of the world with laws or other requirements governing personal data collection,
                        use, or disclosure that differ from applicable laws in Luxembourg, then through your continued
                        use of the Services, you are transferring your data to Luxembourg, and you expressly consent to
                        have your data transferred to and processed in Luxembourg.</p>
                </div>

                <div class="termsOfService-details2 my-5" id="term-and-termination">
                    <h2 class="launching-h2-title termsOfService-h2-title">16. TERM AND TERMINATION</h2>
                    <br>

                    <p class="map-para line-height-termsOfService">These Legal Terms shall remain in full force and
                        effect while you use the Services. WITHOUT LIMITING ANY OTHER PROVISION OF THESE LEGAL TERMS, WE
                        RESERVE THE RIGHT TO, IN OUR SOLE DISCRETION AND WITHOUT NOTICE OR LIABILITY, DENY ACCESS TO AND
                        USE OF THE SERVICES (INCLUDING BLOCKING CERTAIN IP ADDRESSES), TO ANY PERSON FOR ANY REASON OR
                        ...
                        YOUR USE OR PARTICIPATION IN THE SERVICES OR DELETE YOUR ACCOUNT AND ANY CONTENT OR INFORMATION
                        THAT YOU POSTED AT ANY TIME, WITHOUT WARNING, IN OUR SOLE DISCRETION.</p>
                    <p class="map-para line-height-termsOfService">If we terminate or suspend your account for any
                        reason, you are prohibited from registering and creating a new account under your name, a fake
                        or borrowed name, or the name of any third party, even if you may be acting on behalf of the
                ...
                <div class="termsOfService-details2 my-5" id="modifications-and-interruptions">
                    <h2 class="launching-h2-title termsOfService-h2-title">17. MODIFICATIONS AND INTERRUPTIONS</h2>
                    <br>

                    <p class="map-para line-height-termsOfService">We reserve the right to change, modify, or remove the
                        contents of the Services at any time or for any reason at our sole discretion without notice.
                        However, we have no obligation to update any information on our Services. We will not be liable
                        to you or any third party for any modification, price change, suspension, or discontinuance of
                        the Services.</p>
                    <p class="map-para line-height-termsOfService">We cannot guarantee the Services will be available at
                        all times. We may experience hardware, software, or other problems or need to perform
                        maintenance related to the Services, resulting in interruptions, delays, or errors. We reserve
                        the right to change, revise, update, suspend, discontinue, or otherwise modify the Services at
                ...
                <div class="termsOfService-details2 my-5" id="governing-law">
                    <h2 class="launching-h2-title termsOfService-h2-title">18. GOVERNING LAW</h2>
                    <br>

                    <p class="map-para line-height-termsOfService">These Legal Terms are governed by and interpreted
                        following the laws of Luxembourg, and the use of the United Nations Convention of Contracts for
                        ...
                        provisions of the law in your country to residence. RevvdOut and yourself both agree to submit
                        to the non-exclusive jurisdiction of the courts of Luxembourg, which means that you may make a
                        claim to defend your consumer protection rights in regards to these Legal Terms in Luxembourg,
                        or in the EU country in which you reside.</p>
                </div>

                <div class="termsOfService-details2 my-5" id="dispute-resolution">
                    <h2 class="launching-h2-title termsOfService-h2-title">19. DISPUTE RESOLUTION</h2>
                    <br>
                    <p class="banner-para termsOfService-para">Informal Negotiations</p>

                    <p class="map-para line-height-termsOfService">To expedite resolution and control the cost of any
                    ...
                    <p class="banner-para termsOfService-para">Binding Arbitration</p>
                    <p class="map-para line-height-termsOfService">Any dispute arising from the relationships between
                        the Parties to these Legal Terms shall be determined by one arbitrator who will be chosen in
                        accordance with the Arbitration and Internal Rules of the European Court of Arbitration being
                        ...
                        constitutes acceptance. The seat of arbitration shall be Luxembourg, Luxembourg. The language of
                        the proceedings shall be English. Applicable rules of substantive law shall be the law of
                        Luxembourg.</p>

                    <p class="banner-para termsOfService-para">Restrictions</p>
                    <p class="map-para line-height-termsOfService">The Parties agree that any arbitration shall be
                        limited to the Dispute between the Parties individually. To the full extent permitted by law,
                        (a) no arbitration shall be joined with any other proceeding; (b) there is no right or authority
                        for any Dispute to be arbitrated on a class-action basis or to utilize class action procedures;
                    ...
                    <p class="banner-para termsOfService-para">Exceptions to Informal Negotiations and Arbitration</p>
                    <p class="map-para line-height-termsOfService">The Parties agree that the following Disputes are not
                ...
                <div class="termsOfService-details2 my-5" id="corrections">
                    <h2 class="launching-h2-title termsOfService-h2-title">20. CORRECTIONS</h2>
                    <br>

                    <p class="map-para line-height-termsOfService">There may be information on the Services that
                ...
                <div class="termsOfService-details2 my-5" id="disclaimer">
                    <h2 class="launching-h2-title termsOfService-h2-title">21. DISCLAIMER</h2>
                    <br>

                    <p class="map-para line-height-termsOfService">THE SERVICES ARE PROVIDED ON AN AS-IS AND
                        ...
                        USE OF THE SERVICES, (3) ANY UNAUTHORIZED ACCESS TO OR USE OF OUR SECURE SERVERS AND/OR ANY AND
                ...
                <div class="termsOfService-details2 my-5" id="limitations-of-liability">
                    <h2 class="launching-h2-title termsOfService-h2-title">22. LIMITATIONS OF LIABILITY</h2>
                    <br>

                    <p class="map-para line-height-termsOfService">IN NO EVENT WILL WE OR OUR DIRECTORS, EMPLOYEES, OR
                        ...
                        OTHER DAMAGES ARISING FROM YOUR USE OF THE SERVICES, EVEN IF WE HAVE BEEN ADVISED OF THE
                        POSSIBILITY OF SUCH DAMAGES. NOTWITHSTANDING ANYTHING TO THE CONTRARY CONTAINED HEREIN, OUR
                        LIABILITY TO YOU FOR ANY CAUSE WHATSOEVER AND REGARDLESS OF THE FORM OF THE ACTION, WILL AT ALL
                        TIMES BE LIMITED TO THE AMOUNT PAID, IF ANY, BY YOU TO US DURING THE ONE (1) MONTH PERIOD PRIOR
                        ...
                        YOU MAY HAVE ADDITIONAL RIGHTS.</p>
                </div>

                <div class="termsOfService-details2 my-5" id="indemnification">
                    <h2 class="launching-h2-title termsOfService-h2-title">23. INDEMNIFICATION</h2>
                    <br>

                    <p class="map-para line-height-termsOfService">You agree to defend, indemnify, and hold us harmless,
                        ...
                        reasonable attorneys’ fees and expenses, made by any third party due to or arising out of: (1)
                        your Contributions; (2) use of the Services; (3) breach of these Legal Terms; (4) any breach of
                        your representations and warranties set forth in these Legal Terms; (5) your violation of the
                        rights of a third party, including but not limited to intellectual property rights; or (6) any
                ...
                <div class="termsOfService-details2 my-5" id="user-data">
                    <h2 class="launching-h2-title termsOfService-h2-title">24. USER DATA</h2>
                    <br>

                    <p class="map-para line-height-termsOfService">We will maintain certain data that you transmit to
                        the Services for the purpose of managing the performance of the Services, as well as data
                        relating to your use of the Services. Although we perform regular routine backups of data, you
                ...
                <div class="termsOfService-details2 my-5" id="electronic-communications">
                    <h2 class="launching-h2-title termsOfService-h2-title">25. ELECTRONIC COMMUNICATIONS, TRANSACTIONS,
                        AND SIGNATURES</h2>
                    <br>

                    <p class="map-para line-height-termsOfService">Visiting the Services, sending us emails, and
                ...
                <div class="termsOfService-details2 my-5" id="california-users">
                    <h2 class="launching-h2-title termsOfService-h2-title">26. CALIFORNIA USERS AND RESIDENTS</h2>
                    <br>

                    <p class="map-para line-height-termsOfService">If any complaint with us is not satisfactorily
                        resolved, you can contact the Complaint Assistance Unit of the Division of Consumer Services of
                        the California Department of Consumer Affairs in writing at 1625 North Market Blvd., Suite N
                        112, Sacramento, California 95834 or by telephone at (800) 952-5210 or (916) 445-1254.</p>
                </div>

                <div class="termsOfService-details2 my-5" id="miscellaneous">
                    <h2 class="launching-h2-title termsOfService-h2-title">27. MISCELLANEOUS</h2>
                    <br>

                    <p class="map-para line-height-termsOfService">These Legal Terms and any policies or operating rules
                        ...
                        to execute these Legal Terms.</p>
                </div>

                <div class="termsOfService-details2 my-5" id="contact-us">
                    <h2 class="launching-h2-title termsOfService-h2-title">28. CONTACT US</h2>
                    <br>

                    <p class="map-para line-height-termsOfService">In order to resolve a complaint regarding the
                        Services or to receive further information regarding use of the Services, please contact us at:
                    </p>

                    <div class="brand">RevvdOut</div>
