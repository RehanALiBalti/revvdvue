...
export default {
    ...
    methods: {
        ...
        //     const apiUrl = `http://52.59.240.119/apicomments/count?community_id=${id}`;
        ...
        //         const response = await axios.get('http://52.59.240.119/apicommunities/filter', {
        //             params: {
        //                 make: this.make,
        //                 model: this.modal,
        ...
        getNoOfComments(community) {
            const apiUrl = `http://52.59.240.119/apicomments/count?community_id=${community.id}`;
