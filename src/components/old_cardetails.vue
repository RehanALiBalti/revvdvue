                    ...
                    <div class="swiper-container swiper-width px-3 sp-con-top">
                        <div class="swiper-wrapper position-relative swp-top" ref="viewerContainer">
                            <div v-for="(image, index) in images" :key="index" class="swiper-slide swiper-adjustment">
                                <img :src="require(`@/assets/images/${image}`)" class="slider-img car-image-slider2"
                                    alt="car" @click="openViewer(index)" />
                                            ...
                                            <div class="col-md-12">
                                                <div class="row g-1">
                                                    <div class="col-md-6 " v-for="(detail, i) in car.page1" :key="i">
                                                        <div class="">
                                                            <p class="text-white "><span class="fw-bolder">{{
                                                                    detail.label }}:</span> {{ detail.value
                                                                }}
                                                            </p>
                                                        </div>
                                ...
                                <div class="swiper-slide tilt-sp2">
                                    ...
                                    <div class="text-content-slide">
                                        ...
                                        <form @submit.prevent="submitInquiry" class="row g-2 me-3">
                                            <div class="col-md-6">
                                                <input class="form-control form-Input h35px" type="text"
                                                    v-model="form.name" placeholder="Name" required />
                                            </div>
                                            <div class="col-md-6">
                                                <input class="form-control form-Input h35px" type="email"
                                                    v-model="form.email" placeholder="Email" required />
                                            </div>
                                            <div class="col-md-6">
                                                <input class="form-control form-Input h35px" type="tel"
                                                    v-model="form.phone" placeholder="Phone" required />
                                            </div>
                                            <div class="col-md-12">
                                            ...
                                            <label class="text-align-start">
                                                <input class="form-check-input border-0 me-2" type="checkbox"
                                                    v-model="form.terms" />
                                            ...
                                            <div class="card card-bg my-2 ">
                                                ...
                                                <div class="row mx-1 my-3">
                                                    ...
                                                    <div class="col-12 col-md-8">
                                                        ...
                                                        <div class="card-m-h">
                                                            <p class="car-title">Mercedes <span>AMG GT63s 4 door</span>
                                                            </p>
                                                            <div class="row my-1">
                                                                <div class="col-12 col-md-4">
                                                                    <p class="car-sec-text"> Price:<span>$</span>
                                                                        250,000 </p>
                                                                </div>
                                                                <div class="col-12 col-md-4">
